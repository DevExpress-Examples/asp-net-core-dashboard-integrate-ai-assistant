...
> [!Important]
> We use version **9.4.0-preview.1.25207.5** of the _Microsoft.Extensions.AI.*_ libraries in our source code. We do not guarantee compatibility or correct operation with higher versions. 
